...
<head>
    <meta charset="utf-8">
    <title>MUCOFACO Administrator</title>
...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class=""></i>MUCOFACO  </h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="images
                        /nwow.png" alt="" style="width: 40px; height: 40px;">
                        <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0">MocuFaco Administrator</h6>
                        <span></span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                 
                    <a href="/members/create" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Add Member</a>
                    <a href="/Ebike" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Ebike Parts</a>
                    <a href="" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>EbikeList</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="images
                            /nwow.png" alt="" style="width: 40px; height: 40px;">
    ...
    <div class="bg-light rounded-top p-4 text-center"> <!-- Added text-center class -->
        <div class="row">
            <div class="col-12 col-sm-6 mx-auto"> <!-- Added mx-auto class for horizontal centering -->
                <img src="../images
                /nwow.png" alt="" class="mx-auto d-block"> <!-- Center the image using mx-auto and d-block classes -->
                <br>
                <p class="mx-auto">Nwow Ebike Admin</p> <!-- Center the paragraph using mx-auto class -->
            </div>
        </div>
    </div>
</div>
